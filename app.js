// ==========================================
// DATA SOAL MULTIPLE CHOICE (20 SOAL) - CERITA LENGKAP
// ==========================================
const mcQuestions = [
    {
        context: "Mia is a cheerful fourth-grade student. She really likes wearing her favorite blue dress. One sunny afternoon, Mia goes to the park near her house to play. While walking around, she sees a small white cat sitting under a tree.",
    ...
    },
    {
        ...
        options: ["A. A car", "B. A bicycle", "C. A bus", "D. A train"],
        correct: 1,
        level: "Easy"
    },
    {
    ...
    {
        context: "Siti is a diligent girl who always brings lunch from home. Today, she brings rice, fried chicken, and a fresh red apple in her lunch box. She feels happy because she can eat with her friends at school.",
    ...
    {
        context: "Budi is a disciplined boy. Every morning, he wakes up early before going to school. He always brushes his teeth first and then takes a bath so that he feels clean and fresh.",
    ...
    {
        context: "Lina loves reading storybooks. She has many books at home. Every Sunday, she goes to the library with her sister to borrow new books.",
    ...
    {
        context: "Tina and her friends love playing together. After school, they go to the playground near their school. There, they play on the swings and laugh happily.",
    ...
    {
        context: "Tina and her friends love playing together. After school, they go to the playground near their school. There, they play on the swings and laugh happily.",
        q: "14. What do they play on?",
        options: ["A. Slide", "B. Ball", "C. Swings", "D. Rope"],
        correct: 2,
        level: "Medium"
    },
    {
    ...
    {
        context: "Nina is a helpful girl who likes helping her parents. One day, she helps her mother in the kitchen. She carefully cuts vegetables and washes the dishes after eating.",
    ...
    {
        context: "Rama lives quite far from his school. Because the distance is too far, he cannot walk to school. Therefore, he goes to school by bus every day with his friends.",
        q: "19. How does Rama go to school?",
        options: ["A. On foot", "B. By bicycle", "C. By car", "D. By bus"],
        correct: 3,
        level: "Hard"
    },
    {
        ...
        options: ["A. He is lazy.", "B. His house is far from school.", "C. He likes buses.", "D. He does not have a bicycle."],
        correct: 1,
        level: "Hard"
    }
];
...
// ==========================================
// DATA SOAL ESSAY (5 SOAL) - CERITA LENGKAP
// ==========================================
const essayQuestions = [
    {
        context: "Lala has a very cute pet cat. The cat is black and has soft fur. Every day, it likes to sleep on the sofa in the living room.",
    ...
    {
        context: "Rina is a diligent and responsible girl. She always helps her parents at home by sweeping the floor and cleaning her room. She also studies every night to become a smart student.",
...
function loadMC() {
    ...
    document.getElementById('question-context').innerHTML = 
        '<span class="badge ' + qData.level.toLowerCase() + '">' + qData.level + '</span> 📖 ' + qData.context;
...
function loadEssay() {
    ...
    document.getElementById('essay-context').innerHTML = '📖 ' + qData.context;
